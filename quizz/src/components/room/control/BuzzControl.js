            ...
            <div>
                ...
                <Row>
                    <Col xs="6" md={{ size: 3, offset: 3 }}>
                        <Button color="success" size="lg" block outline onClick={this.props.handleScoreBuzz}>Accepter</Button>
                    </Col>
                    <Col xs="6" md={{ size: 3, offset: 3 }}>
                        <Button color="danger" size="lg" block outline onClick={this.props.handleCancelBuzz}>Refuser</Button>
                    </Col>
                </Row>
            </div>
        );
